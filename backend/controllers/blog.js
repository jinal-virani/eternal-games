...
const updateBlog = async (req, res) => {
  try {
    ...
    const { blogTitle, blogImage, shortDescription, description, slug } = req.body
    ...
    const updateBlog = await BlogStore.updateOne({ _id: blogId }, { blogTitle, blogImage, shortDescription, description, slug: newSlug })
...
const uploadBlogThumbnail = async (req, res) => {
  try {
    ...
    sendSuccess(res, {
      ...
      url: `https://www.eternalgames.io/` + filePath,
