...
import defaultImg from '../../assets/images/img.png'
                ...
                return (
                    <TableRow hover tabIndex={-1} key={index}>
                      ...
                      <TableCell align="center" sx={{ pr: 3 }} onClick={(e) => {
                        e.stopPropagation()
                        window.open(`https://www.eternalgames.io/blog/${row?.slug}`, '_blank', 'noopener,noreferrer')
                      }}>
                  ...
                  blogs.map((row, index) => {
                    ...
                    return (
                        <TableRow hover
                          ...
                          <TableCell align="center" sx={{ pr: 3 }} onClick={(e) => {
                            e.stopPropagation()
                            window.open(`https://www.eternalgames.io/blogs/${row?.slug}`, '_blank', 'noopener,noreferrer')
                          }}>
                            <IconButton
                                color="primary"
                            >
